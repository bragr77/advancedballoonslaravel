                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8 wide-col-laptop">
                        <div class="title-block animate titulo-galeria mt-5" data-animate="fadeInUp">
                            <h3 class="d-none d-md-block">Anniversaries</h3>
                            <h4 class="d-sm-block d-md-none pt-3" style="font-size: 1.5em;">Anniversaries</h4>
                            <a href="javascript:history.back(-1);" class="btn btn-servicios5">Return</a>
                        </div>
                        ...
                        <div class="services-list owl-carousel" id="servicescarrusel">
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/aniversarios/aniversariocuarto.jpg" alt="Balloon room arrangement for anniversary">
                                    <h3 class="h3-servicios5">Room arrangement</h3>
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/aniversarios/aniversariopared.jpg" alt="Balloon wall arrangement for anniversary">
                                    <h3 class="h3-servicios5">Wall arrangement</h3>
                                    <a href="https://api.whatsapp.com/send?phone=17542455353&text=Saludos.%20necesito%20informaci%C3%B3n" target="_blank" class="btn btn-servicios5 btn-block">I want it!</a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/aniversarios/aniversariobuquet.jpg" alt="Balloon bouquet for anniversary">
                                    <h3 class="h3-servicios5">Balloon Bouquet</h3>
                                    <a href="https://api.whatsapp.com/send?phone=17542455353&text=Saludos.%20necesito%20informaci%C3%B3n" target="_blank" class="btn btn-servicios5 btn-block">I want it!</a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/aniversarios/aniversarioorganico.jpg" alt="Organic balloon decoration for anniversary">
                                    <h3 class="h3-servicios5">Organic Decoration</h3>
                                    <a href="https://api.whatsapp.com/send?phone=17542455353&text=Saludos.%20necesito%20informaci%C3%B3n" target="_blank" class="btn btn-servicios5 btn-block">I want it!</a>
                                </div>
                            </div>
