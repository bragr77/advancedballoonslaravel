                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8 wide-col-laptop">
                        <div class="title-block animate titulo-galeria mt-5" data-animate="fadeInUp">
                            <h3 class="d-none d-md-block">Bebes</h3>
                            <h4 class="d-sm-block d-md-none pt-3" style="font-size: 1.5em;">Bebes</h4>
                        ...
                        <div class="services-list owl-carousel" id="servicescarrusel">
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/bebes/babyshower.jpg" alt="Arreglo de globos para baby showers">
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/bebes/ninoonina.jpg" alt="Arreglo de globos para niño o niña">
                                    <h3 class="h3-servicios7">Niño/Niña</h3>
                                    <!-- <p>Elaboración de arcos y gurinaldas de globos oarganica para interiores y exteriores.</p> -->
                                    <a href="https://api.whatsapp.com/send?phone=17542455353&text=Saludos.%20necesito%20informaci%C3%B3n" target="_blank" class="btn btn-servicios7 btn-block">¡Lo quiero!</a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="service-box">
                                    <img class="img-galeria" src="frontend/images/servicios/bebes/bienvenido.jpg" alt="Arreglo de globos para bienvenidas de niños">
                                    <h3 class="h3-servicios7">Bienvenido</h3>
                                    <!-- <p>Elaboración de arcos y gurinaldas de globos oarganica para interiores y exteriores.</p> -->
                                    <a href="https://api.whatsapp.com/send?phone=17542455353&text=Saludos.%20necesito%20informaci%C3%B3n" target="_blank" class="btn btn-servicios7 btn-block">¡Lo quiero!</a>
                                </div>
                            </div>
